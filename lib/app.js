    ...
    self.states.add('states:registration:engagement', function(name) {
       return new ChoiceState(name, {
           ...
           next: function(choice) {
               ...
               self.contact.extra.it_engagement_question = String(Date.now());
        ...
        return new ChoiceState(name, {
           ...
           choices: [
            ...
            next: function(content) {
                ...
                self.contact.extra.it_question1 = String(new Date());
    ...
    self.states.add('states:quiz:tier2:question2',function(name) {
        return new ChoiceState(name, {
            ...
            next: function(content) {
                ...
                self.contact.extra.it_question2 = String(new Date());
    ...
    self.states.add('states:quiz:tier2:question3',function(name) {
        return new ChoiceState(name, {
            ...
            next: function(content) {
                ...
                self.contact.extra.it_question3 = String(new Date());
    ...
    self.states.add('states:quiz:tier2:question4',function(name) {
        return new ChoiceState(name,{
            ...
            next: function(content) {
                ...
                self.contact.extra.it_question4 =String(new Date());
