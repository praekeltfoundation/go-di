...
var GoDiApp = App.extend(function(self) {
    ...
    self.states.add('states:report',function(name) {
        return new ChoiceState(name, {
            ...
            choices: [
                new Choice('election_campaign',$('Election Campaign/Rally Report')),
                new Choice('voilence',$('Voilence/Intimidation Report')),
                new Choice('fraud',$('Fraud/Corruption Report')),
                new Choice('voting_station',$('Voting Station Report')),
                new Choice('post_election',$('Post Election Report'))
            ],
            next: function(content) {
                self.contact.extra.report_type = content.value;
                self.contact.extra.it_report_type = self.get_date();
    ...
    self.states.add('states:report:title',function(name) {
        return new FreeText(name, {
            ...
            next: function(content) {
                ...
                self.contact.extra.it_report_title = self.get_date();
    ...
    self.states.add('states:report:description',function(name) {
        return new FreeText(name, {
            ...
            next: function(content) {
                ...
                self.contact.extra.it_report_desc = self.get_date();
    ...
    self.states.add('states:report:verify_location',function(name,opts) {
        ...
        var choices = _.map(opts.address_options,function(address) {
            index++;
            return new Choice(index-1,address.formatted_address.replace(", South Africa",""));
        });
    ...
    self.states.add('states:report:end',function(name) {
        return new EndState(name, {
