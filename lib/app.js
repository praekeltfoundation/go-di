...
var ushahidigo = require('./ushahidi.js');
var UshahidiApi = ushahidigo.UshahidiApi;
...
var GoDiApp = App.extend(function(self) {
    ...
    self.get_location_str = function(content){
        return (content.toLowerCase().indexOf("south africa") > 0) ? content : [content,"south africa"].join(' ');
    };
