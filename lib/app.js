...
var GoDiApp = App.extend(function(self) {
    ...
    self.get_terms_and_conditions = function() {
         var text =  "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
             "Duis euismod nisi in auctor venenatis. " +
             "Donec rhoncus euismod tellus at ullamcorper. " +
             "Integer ac egestas tellus orci aliquam. " +
             "Lorem ipsum dolor sit amet, consectetur adipiscing elit. " +
             "Quisque faucibus lectus id elementum placerat. " +
             "Vivamus ac euismod orci. Mauris viverra est diam, sit amet ultricies nullam";
        return text;
    };
    ...
    self.states.add('states:registration:read',function(name){
        ...
        return self.im.contacts.save(self.contact).then(function() {
            ...
            var tandc = self.get_terms_and_conditions();
            var pages = Math.ceil(tandc / 145);
            //console.log(tandc);
            console.log(self.get_terms_and_conditions().substr(0,145));
            console.log(self.get_terms_and_conditions().substr(145,145));
            var bs =  new BookletState(name, {
                pages: pages,
                page_text: function (n) {
                    return self.get_terms_and_conditions().substr(n*145,145);
                },
                buttons: {
                    "1":-1,
                    "2":+1,
